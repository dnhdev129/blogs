<div class="footer">
	<div class="footer_inner_info_w3ls_agileits">
				...
				<div class="col-md-5 sign-gd-two">
					...
					<div class="address">
						...
						<div class="address-grid">
							...
							<div class="address-right">
								<h6>Email Address</h6>
								<p>Email :<a href="mailto:example@email.com"><?php echo $settings->contact_email ?></a></p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="address-grid">
		...
		<div class="clearfix"></div>
		<p class="copy-right"><?php echo $settings->site_footer ?><a target="_blank" href="https://www.templateshub.net">Templates Hub</a></p>
	</div>
</div>
</div>